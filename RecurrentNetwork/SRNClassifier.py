...
class SRNClassifier:
    ...
    def __init__(self, alpha, hidden_layer_size, activation, max_iter = 500, verbose=False, target=1.0):
        self.alpha = alpha
    ...
    def predict(self,x,categorical=True):
        ...
        if categorical:
            ...
            enc = preprocessing.OneHotEncoder(categories=[range(self.num_outputs)])
            enc.fit(y)
